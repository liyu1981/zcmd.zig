...
{"lineNum":"   12","line":""},
{"lineNum":"   13","line":"    pub fn deinit(this: *const SimpleRunResult) void {","class":"lineCov","hits":"1","order":"177",},
{"lineNum":"   14","line":"        this.allocator.free(this.stdout);","class":"lineCov","hits":"1","order":"116",},
{"lineNum":"   15","line":"        this.allocator.free(this.stderr);","class":"lineCov","hits":"1","order":"150",},
{"lineNum":"   16","line":"    }"},
{"lineNum":"   17","line":"};"},
{"lineNum":"   18","line":""},
...
{"lineNum":"   52","line":"        stdout.deinit();","class":"lineCov","hits":"1","order":"165",},
{"lineNum":"   53","line":"        stderr.deinit();","class":"lineCov","hits":"1","order":"136",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":""},
...
{"lineNum":"   60","line":"        try child.stdin.?.writeAll(si);","class":"lineCov","hits":"1","order":"133",},
{"lineNum":"   61","line":"        child.stdin.?.close();","class":"lineCov","hits":"1","order":"132",},
...
{"lineNum":"   99","line":"}) anyerror!std.ChildProcess.RunResult {","class":"lineCov","hits":"1","order":"162",},
{"lineNum":"  100","line":"    var need_free_to_free: bool = false;","class":"lineCov","hits":"1","order":"127",},
{"lineNum":"  101","line":"    var to_free_result: std.ChildProcess.RunResult = undefined;","class":"lineCov","hits":"1","order":"108",},
{"lineNum":"  102","line":"    var need_free_last: bool = true;","class":"lineCov","hits":"1","order":"166",},
{"lineNum":"  103","line":"    var last_run_result: std.ChildProcess.RunResult = undefined;","class":"lineCov","hits":"1","order":"106",},
{"lineNum":"  104","line":"    for (args.commands, 0..) |command, i| {","class":"lineCov","hits":"1","order":"175",},
{"lineNum":"  105","line":"        if (i > 0 and need_free_last) {","class":"lineCov","hits":"1","order":"148",},
{"lineNum":"  106","line":"            to_free_result = last_run_result;","class":"lineCov","hits":"1","order":"153",},
{"lineNum":"  107","line":"            need_free_to_free = true;","class":"lineCov","hits":"1","order":"104",},
{"lineNum":"  108","line":"        }"},
{"lineNum":"  109","line":"        last_run_result = runCommandAndGetResultErr(.{","class":"lineCov","hits":"1","order":"97",},
{"lineNum":"  110","line":"            .allocator = args.allocator,","class":"lineCov","hits":"1","order":"159",},
{"lineNum":"  111","line":"            .command = command,"},
{"lineNum":"  112","line":"            .stdin_input = brk: {"},
{"lineNum":"  113","line":"                if (i == 0) {","class":"lineCov","hits":"1","order":"176",},
{"lineNum":"  114","line":"                    if (args.stdin_input) |stdin_input| break :brk stdin_input else break :brk null;","class":"lineCov","hits":"1","order":"172",},
{"lineNum":"  115","line":"                } else break :brk last_run_result.stdout;","class":"lineCov","hits":"1","order":"130",},
{"lineNum":"  116","line":"            },"},
{"lineNum":"  117","line":"            .cwd = args.cwd,","class":"lineCov","hits":"1","order":"167",},
{"lineNum":"  118","line":"            .cwd_dir = args.cwd_dir,"},
{"lineNum":"  119","line":"            .env_map = args.env_map,","class":"lineCov","hits":"1","order":"82",},
{"lineNum":"  120","line":"            .max_output_bytes = args.max_output_bytes,","class":"lineCov","hits":"1","order":"101",},
{"lineNum":"  121","line":"            .expand_arg0 = args.expand_arg0,","class":"lineCov","hits":"1","order":"98",},
{"lineNum":"  122","line":"        }) catch |err| {"},
{"lineNum":"  123","line":"            defer {"},
{"lineNum":"  124","line":"                if (i > 0 and need_free_to_free) {","class":"lineCov","hits":"1","order":"95",},
{"lineNum":"  125","line":"                    args.allocator.free(to_free_result.stdout);","class":"lineCov","hits":"1","order":"70",},
{"lineNum":"  126","line":"                    args.allocator.free(to_free_result.stderr);","class":"lineCov","hits":"1","order":"93",},
{"lineNum":"  127","line":"                    need_free_to_free = false;","class":"lineCov","hits":"1","order":"117",},
{"lineNum":"  128","line":"                }"},
{"lineNum":"  129","line":"            }"},
{"lineNum":"  130","line":"            if (args.stop_on_any_error) {","class":"lineCov","hits":"1","order":"119",},
{"lineNum":"  131","line":"                return err;","class":"lineCov","hits":"1","order":"140",},
{"lineNum":"  132","line":"            }"},
{"lineNum":"  133","line":"            last_run_result = std.ChildProcess.RunResult{","class":"lineNoCov","hits":"0",},
{"lineNum":"  134","line":"                .term = std.ChildProcess.Term{ .Exited = 1 },"},
{"lineNum":"  135","line":"                .stdout = \"\","},
{"lineNum":"  136","line":"                .stderr = \"\","},
{"lineNum":"  137","line":"            };"},
{"lineNum":"  138","line":"            need_free_last = false;","class":"lineNoCov","hits":"0",},
{"lineNum":"  139","line":"            continue;"},
{"lineNum":"  140","line":"        };"},
{"lineNum":"  141","line":"        defer {"},
{"lineNum":"  142","line":"            if (i > 0 and need_free_to_free) {","class":"lineCov","hits":"1","order":"125",},
{"lineNum":"  143","line":"                args.allocator.free(to_free_result.stdout);","class":"lineCov","hits":"1","order":"74",},
{"lineNum":"  144","line":"                args.allocator.free(to_free_result.stderr);","class":"lineCov","hits":"1","order":"66",},
{"lineNum":"  145","line":"                need_free_to_free = false;","class":"lineCov","hits":"1","order":"142",},
{"lineNum":"  146","line":"            }"},
{"lineNum":"  147","line":"        }"},
{"lineNum":"  148","line":"        switch (last_run_result.term) {","class":"lineCov","hits":"1","order":"103",},
{"lineNum":"  149","line":"            .Exited => |ret| {"},
{"lineNum":"  150","line":"                if (ret != 0 and args.stop_on_any_error) {","class":"lineCov","hits":"1","order":"81",},
{"lineNum":"  151","line":"                    return last_run_result;","class":"lineCov","hits":"1","order":"122",},
{"lineNum":"  152","line":"                }"},
{"lineNum":"  153","line":"                if (last_run_result.stderr.len > 0 and args.stop_on_any_stderr) {","class":"lineCov","hits":"1","order":"77",},
{"lineNum":"  154","line":"                    return last_run_result;","class":"lineCov","hits":"1","order":"71",},
{"lineNum":"  155","line":"                }"},
{"lineNum":"  156","line":"                need_free_last = true;","class":"lineCov","hits":"1","order":"65",},
{"lineNum":"  157","line":"                continue;"},
{"lineNum":"  158","line":"            },"},
{"lineNum":"  159","line":"            else => {"},
{"lineNum":"  160","line":"                if (args.stop_on_any_error) {","class":"lineNoCov","hits":"0",},
{"lineNum":"  161","line":"                    return last_run_result;","class":"lineNoCov","hits":"0",},
{"lineNum":"  162","line":"                }"},
{"lineNum":"  163","line":"                need_free_last = true;","class":"lineNoCov","hits":"0",},
{"lineNum":"  164","line":"                continue;"},
{"lineNum":"  165","line":"            },"},
{"lineNum":"  166","line":"        }"},
{"lineNum":"  167","line":"    }"},
{"lineNum":"  168","line":"    return last_run_result;","class":"lineCov","hits":"1","order":"105",},
{"lineNum":"  169","line":"}"},
{"lineNum":"  170","line":""},
...
{"lineNum":"  196","line":"        stderr_writer.print(\"Command: {s} spawn failed {any}! Error!\\n\", .{ args.command, err }) catch {};","class":"lineCov","hits":"1","order":"163",},
{"lineNum":"  197","line":"        @panic(panic_msg);","class":"lineCov","hits":"1","order":"161",},
{"lineNum":"  198","line":"    };"},
...
{"lineNum":"  202","line":"                return SimpleRunResult{","class":"lineCov","hits":"1","order":"149",},
{"lineNum":"  203","line":"                    .allocator = args.allocator,","class":"lineCov","hits":"1","order":"151",},
{"lineNum":"  204","line":"                    .stdout = brk: {"},
{"lineNum":"  205","line":"                        if (args.trim_stdout) {","class":"lineCov","hits":"1","order":"157",},
{"lineNum":"  206","line":"                            defer args.allocator.free(rr.stdout);","class":"lineCov","hits":"1","order":"155",},
{"lineNum":"  207","line":"                            break :brk _toOwnedSlice(","class":"lineCov","hits":"1","order":"160",},
{"lineNum":"  208","line":"                                u8,"},
{"lineNum":"  209","line":"                                args.allocator,","class":"lineCov","hits":"1","order":"156",},
{"lineNum":"  210","line":"                                std.mem.trim(u8, rr.stdout, \" \\t\\n\\r\"),","class":"lineCov","hits":"1","order":"178",},
{"lineNum":"  211","line":"                            ) catch {"},
{"lineNum":"  212","line":"                                @panic(\"trim stdout OOM!\");"},
{"lineNum":"  213","line":"                            };"},
{"lineNum":"  214","line":"                        } else break :brk rr.stdout;","class":"lineCov","hits":"1","order":"174",},
{"lineNum":"  215","line":"                    },"},
{"lineNum":"  216","line":"                    .stderr = brk: {"},
{"lineNum":"  217","line":"                        if (args.trim_stderr) {","class":"lineCov","hits":"1","order":"169",},
{"lineNum":"  218","line":"                            defer args.allocator.free(rr.stderr);","class":"lineCov","hits":"1","order":"143",},
{"lineNum":"  219","line":"                            break :brk _toOwnedSlice(","class":"lineCov","hits":"1","order":"144",},
{"lineNum":"  220","line":"                                u8,"},
{"lineNum":"  221","line":"                                args.allocator,","class":"lineCov","hits":"1","order":"146",},
{"lineNum":"  222","line":"                                std.mem.trim(u8, rr.stderr, \" \\t\\n\\r\"),","class":"lineCov","hits":"1","order":"145",},
{"lineNum":"  223","line":"                            ) catch {"},
{"lineNum":"  224","line":"                                @panic(\"trim stderr OOM!\");"},
{"lineNum":"  225","line":"                            };"},
{"lineNum":"  226","line":"                        } else break :brk rr.stderr;","class":"lineCov","hits":"1","order":"158",},
{"lineNum":"  227","line":"                    },"},
{"lineNum":"  228","line":"                };"},
...
{"lineNum":"  234","line":"            stderr_writer.print(\"Command: {s} exited with signal {d}! Error!\", .{ args.command, ret }) catch {};","class":"lineCov","hits":"1","order":"182",},
{"lineNum":"  235","line":"        },"},
...
{"lineNum":"  273","line":"}, comptime panic_msg: []const u8) SimpleRunResult {","class":"lineCov","hits":"1","order":"72",},
{"lineNum":"  274","line":"    var to_free_result: SimpleRunResult = undefined;","class":"lineCov","hits":"1","order":"90",},
{"lineNum":"  275","line":"    var last_run_result: SimpleRunResult = undefined;","class":"lineCov","hits":"1","order":"88",},
{"lineNum":"  276","line":"    for (args.commands, 0..) |command, i| {","class":"lineCov","hits":"1","order":"73",},
{"lineNum":"  277","line":"        if (i > 0) {","class":"lineCov","hits":"1","order":"91",},
{"lineNum":"  278","line":"            to_free_result = last_run_result;","class":"lineCov","hits":"1","order":"79",},
{"lineNum":"  279","line":"        }"},
{"lineNum":"  280","line":""},
{"lineNum":"  281","line":"        last_run_result = runCommandAndGetResult(.{","class":"lineCov","hits":"1","order":"75",},
{"lineNum":"  282","line":"            .allocator = args.allocator,","class":"lineCov","hits":"1","order":"67",},
{"lineNum":"  283","line":"            .command = command,"},
{"lineNum":"  284","line":"            .stdin_input = brk: {"},
{"lineNum":"  285","line":"                if (i == 0) {","class":"lineCov","hits":"1","order":"76",},
{"lineNum":"  286","line":"                    if (args.stdin_input) |stdin_input| break :brk stdin_input else break :brk null;","class":"lineCov","hits":"1","order":"83",},
{"lineNum":"  287","line":"                } else break :brk last_run_result.stdout;","class":"lineCov","hits":"1","order":"80",},
{"lineNum":"  288","line":"            },"},
{"lineNum":"  289","line":"            .cwd = args.cwd,","class":"lineCov","hits":"1","order":"87",},
{"lineNum":"  290","line":"            .cwd_dir = args.cwd_dir,"},
{"lineNum":"  291","line":"            .env_map = args.env_map,","class":"lineCov","hits":"1","order":"78",},
{"lineNum":"  292","line":"            .max_output_bytes = args.max_output_bytes,","class":"lineCov","hits":"1","order":"85",},
{"lineNum":"  293","line":"            .expand_arg0 = args.expand_arg0,","class":"lineCov","hits":"1","order":"84",},
{"lineNum":"  294","line":"        }, panic_msg);"},
{"lineNum":"  295","line":""},
{"lineNum":"  296","line":"        defer {"},
{"lineNum":"  297","line":"            if (i > 0) {","class":"lineCov","hits":"1","order":"128",},
{"lineNum":"  298","line":"                to_free_result.deinit();","class":"lineCov","hits":"1","order":"107",},
{"lineNum":"  299","line":"            }"},
{"lineNum":"  300","line":"        }"},
{"lineNum":"  301","line":""},
{"lineNum":"  302","line":"        if (args.stop_on_any_stderr and last_run_result.stderr.len > 0) {","class":"lineCov","hits":"1","order":"147",},
{"lineNum":"  303","line":"            return last_run_result;","class":"lineCov","hits":"1","order":"154",},
{"lineNum":"  304","line":"        }"},
{"lineNum":"  305","line":"    }"},
{"lineNum":"  306","line":"    return last_run_result;","class":"lineCov","hits":"1","order":"96",},
{"lineNum":"  307","line":"}"},
{"lineNum":"  308","line":""},
{"lineNum":"  309","line":"// internal functions"},
{"lineNum":"  310","line":""},
{"lineNum":"  311","line":"fn _toOwnedSlice(comptime T: type, allocator: std.mem.Allocator, src: []const T) anyerror![]T {","class":"lineCov","hits":"1","order":"173",},
{"lineNum":"  312","line":"    const new_slice = try allocator.alloc(T, src.len);","class":"lineCov","hits":"1","order":"131",},
{"lineNum":"  313","line":"    @memcpy(new_slice, src);","class":"lineCov","hits":"1","order":"129",},
{"lineNum":"  314","line":"    return new_slice;","class":"lineCov","hits":"1","order":"168",},
{"lineNum":"  315","line":"}"},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"fn _testIsError(comptime T: type, maybe_value: anyerror!T, expected_error: anyerror) bool {","class":"lineCov","hits":"1","order":"100",},
{"lineNum":"  318","line":"    if (maybe_value) |_| {","class":"lineCov","hits":"1","order":"99",},
{"lineNum":"  319","line":"        return false;","class":"lineCov","hits":"1","order":"69",},
{"lineNum":"  320","line":"    } else |err| {"},
{"lineNum":"  321","line":"        return err == expected_error;","class":"lineCov","hits":"1","order":"94",},
{"lineNum":"  322","line":"    }"},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
{"lineNum":"  325","line":"// all tests"},
{"lineNum":"  326","line":""},
{"lineNum":"  327","line":"test \"single cmd test\" {","class":"lineCov","hits":"1","order":"118",},
{"lineNum":"  328","line":"    const allocator = std.testing.allocator;","class":"lineCov","hits":"1","order":"141",},
{"lineNum":"  329","line":"    {"},
{"lineNum":"  330","line":"        const result = runCommandAndGetResult(.{","class":"lineCov","hits":"1","order":"139",},
{"lineNum":"  331","line":"            .allocator = allocator,"},
{"lineNum":"  332","line":"            .command = &[_][]const u8{ \"uname\", \"-a\" },"},
{"lineNum":"  333","line":"        }, \"test uname -a\");"},
{"lineNum":"  334","line":"        defer result.deinit();","class":"lineCov","hits":"1","order":"137",},
{"lineNum":"  335","line":"        try testing.expect(result.stdout.len > 0);","class":"lineCov","hits":"1","order":"138",},
{"lineNum":"  336","line":"        try testing.expect(result.stderr.len == 0);","class":"lineCov","hits":"1","order":"126",},
{"lineNum":"  337","line":"    }"},
{"lineNum":"  338","line":"    {"},
{"lineNum":"  339","line":"        const result = runCommandAndGetResult(.{","class":"lineCov","hits":"1","order":"124",},
...
{"lineNum":"  343","line":"        defer result.deinit();","class":"lineCov","hits":"1","order":"164",},
{"lineNum":"  344","line":"        try testing.expect(result.stdout.len == 0);","class":"lineCov","hits":"1","order":"135",},
{"lineNum":"  345","line":"        try testing.expect(result.stderr.len > 0);","class":"lineCov","hits":"1","order":"102",},
{"lineNum":"  346","line":"    }"},
{"lineNum":"  347","line":"    {"},
{"lineNum":"  348","line":"        const result = runCommandAndGetResult(.{","class":"lineCov","hits":"1","order":"123",},
...
{"lineNum":"  354","line":"        defer result.deinit();","class":"lineCov","hits":"1","order":"120",},
{"lineNum":"  355","line":"        try testing.expect(result.stdout.len > 0);","class":"lineCov","hits":"1","order":"121",},
{"lineNum":"  356","line":"        try testing.expect(result.stderr.len == 0);","class":"lineCov","hits":"1","order":"134",},
{"lineNum":"  357","line":"    }"},
{"lineNum":"  358","line":"}"},
{"lineNum":"  359","line":""},
{"lineNum":"  360","line":"test \"pipe cmd test\" {","class":"lineCov","hits":"1","order":"115",},
{"lineNum":"  361","line":"    const allocator = std.testing.allocator;"},
{"lineNum":"  362","line":"    {"},
{"lineNum":"  363","line":"        const result = try runPipedCommandsAndGetResultErr(.{","class":"lineCov","hits":"1","order":"114",},
...
{"lineNum":"  372","line":"            allocator.free(result.stdout);","class":"lineCov","hits":"1","order":"112",},
{"lineNum":"  373","line":"            allocator.free(result.stderr);","class":"lineCov","hits":"1","order":"111",},
{"lineNum":"  374","line":"        }"},
{"lineNum":"  375","line":"        try testing.expect(result.stdout.len > 0);","class":"lineCov","hits":"1","order":"113",},
{"lineNum":"  376","line":"        try testing.expect(result.stderr.len == 0);","class":"lineCov","hits":"1","order":"110",},
{"lineNum":"  377","line":"    }"},
{"lineNum":"  378","line":"    {"},
{"lineNum":"  379","line":"        var result = runPipedCommandAndGetResult(.{","class":"lineCov","hits":"1","order":"68",},
...
{"lineNum":"  387","line":"        defer result.deinit();","class":"lineCov","hits":"1","order":"171",},
{"lineNum":"  388","line":"        try testing.expect(result.stdout.len > 0);","class":"lineCov","hits":"1","order":"170",},
{"lineNum":"  389","line":"        try testing.expect(result.stderr.len == 0);","class":"lineCov","hits":"1","order":"86",},
{"lineNum":"  390","line":"    }"},
{"lineNum":"  391","line":"    {"},
{"lineNum":"  392","line":"        const maybe_result = runPipedCommandsAndGetResultErr(.{","class":"lineCov","hits":"1","order":"109",},
...
{"lineNum":"  398","line":"            },"},
{"lineNum":"  399","line":"        });"},
{"lineNum":"  400","line":"        try testing.expect(_testIsError(","class":"lineCov","hits":"1","order":"152",},
...
{"lineNum":"  405","line":"    }"},
{"lineNum":"  406","line":"    {"},
{"lineNum":"  407","line":"        const result = try runPipedCommandsAndGetResultErr(.{","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  416","line":"            allocator.free(result.stdout);","class":"lineNoCov","hits":"0",},
{"lineNum":"  417","line":"            allocator.free(result.stderr);","class":"lineNoCov","hits":"0",},
{"lineNum":"  418","line":"        }"},
{"lineNum":"  419","line":"        try testing.expect(result.stdout.len > 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  420","line":"        try testing.expect(result.stderr.len == 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  421","line":"    }"},
{"lineNum":"  422","line":"    {"},
{"lineNum":"  423","line":"        var result = runPipedCommandAndGetResult(.{","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  431","line":"        defer result.deinit();","class":"lineNoCov","hits":"0",},
{"lineNum":"  432","line":"        try testing.expect(result.stdout.len == 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  433","line":"        try testing.expectEqualSlices(u8, result.stderr, \"cat: notexist.txt: No such file or directory\");","class":"lineNoCov","hits":"0",},
{"lineNum":"  434","line":"    }"},
{"lineNum":"  435","line":"    {"},
{"lineNum":"  436","line":"        const result = try runPipedCommandsAndGetResultErr(.{","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  445","line":"            allocator.free(result.stdout);","class":"lineNoCov","hits":"0",},
{"lineNum":"  446","line":"            allocator.free(result.stderr);","class":"lineNoCov","hits":"0",},
{"lineNum":"  447","line":"        }"},
{"lineNum":"  448","line":"        try testing.expectEqual(result.term.Signal, 6); // 6 is SIGABRT","class":"lineNoCov","hits":"0",},
{"lineNum":"  449","line":"        try testing.expect(result.stdout.len == 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  450","line":"        try testing.expect(result.stderr.len == 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  451","line":"    }"},
{"lineNum":"  452","line":"    {"},
{"lineNum":"  453","line":"        const result = try runPipedCommandsAndGetResultErr(.{","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  462","line":"            allocator.free(result.stdout);","class":"lineNoCov","hits":"0",},
{"lineNum":"  463","line":"            allocator.free(result.stderr);","class":"lineNoCov","hits":"0",},
{"lineNum":"  464","line":"        }"},
{"lineNum":"  465","line":"        try testing.expectEqual(result.term.Exited, 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  466","line":"        try testing.expect(result.stdout.len > 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  467","line":"        try testing.expect(result.stderr.len == 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"  468","line":"    }"},
{"lineNum":"  469","line":"}"},
{"lineNum":"  470","line":""},
{"lineNum":"  471","line":"test \"forbidden city\" {","class":"lineCov","hits":"1","order":"89",},
{"lineNum":"  472","line":"    {"},
{"lineNum":"  473","line":"        const maybe_value: anyerror!usize = 5;"},
{"lineNum":"  474","line":"        try testing.expect(!_testIsError(","class":"lineCov","hits":"1","order":"92",},
...
var header = { "command" : "zcmd_kcov_test4", "date" : "2024-01-14 21:41:17", "instrumented" : 173, "covered" : 147,};
var merged_data = [];
